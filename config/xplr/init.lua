...
-- only non-default settings inclucded here: https://xplr.dev/en/general-config
local general = {
...
-- -- Type: [Style](https://xplr.dev/en/style)
-- focus_ui.style = { add_modifiers = { "Bold" } }
...
-- --
-- -- Type: nullable string
-- sort_and_filter_ui.default_identifier.format = nil
...
-- --
-- -- Type: [Style](https://xplr.dev/en/style)
-- sort_and_filter_ui.sort_direction_identifiers.forward.style = nil
...
-- --
-- -- Type: [Style](https://xplr.dev/en/style)
-- sort_and_filter_ui.sort_direction_identifiers.reverse.style = nil
...
-- sort_and_filter_ui.search_identifier = {
-- 	format = "search:",
-- 	style = {},
-- }
...
-- --
-- -- Type: nullable string
-- panel_ui.default.title.format = nil
...
-- --
-- -- Type: nullable list of [Border](https://xplr.dev/en/borders#border)
-- panel_ui.help_menu.borders = nil
-- -- Type of the borders for help menu panel.
-- --
-- -- Type: nullable [Border Type](https://xplr.dev/en/borders#border-type)
-- panel_ui.help_menu.border_type = nil
...
-- --
-- -- Type: nullable string
-- panel_ui.input_and_logs.title.format = nil
...
-- --
-- -- Type: nullable list of [Border](https://xplr.dev/en/borders#border)
-- panel_ui.input_and_logs.borders = nil
-- -- Type of the borders for input & logs panel.
-- --
-- -- Type: nullable [Border Type](https://xplr.dev/en/borders#border-type)
-- panel_ui.input_and_logs.border_type = nil
...
-- --
-- -- Type: nullable string
-- panel_ui.selection.title.format = nil
...
-- --
-- -- Type: nullable list of [Border](https://xplr.dev/en/borders#border)
-- panel_ui.selection.borders = nil
-- -- Type of the borders for selection panel.
-- --
-- -- Type: nullable [Border Type](https://xplr.dev/en/borders#border-type)
-- panel_ui.selection.border_type = nil
...
-- --
-- -- Type: nullable string
-- panel_ui.sort_and_filter.title.format = nil
...
-- --
-- -- Type: nullable list of [Border](https://xplr.dev/en/borders#border)
-- panel_ui.sort_and_filter.borders = nil
-- -- Type of the borders for sort & filter panel.
-- --
-- -- Type: nullable [Border Type](https://xplr.dev/en/borders#border-type)
-- panel_ui.sort_and_filter.border_type = nil
