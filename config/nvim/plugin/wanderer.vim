...
call s:h("htmlBold",                  { "fg": s:yellow_D, "gui": "bold"})
call s:h("htmlBoldItalic",            { "fg": s:green, "gui": "bold,italic"})
...
call s:h("markdownBold",              { "fg": s:yellow_D, "gui": "bold"})
call s:h("markdownBoldItalic",        { "fg": s:green, "gui": "bold,italic"})
...
call s:h("markdownUrl",               { "fg": s:cyan, "gui": "underline"})
